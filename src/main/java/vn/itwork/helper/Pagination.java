...
public class Pagination {
   ...
   public String html_sm_pullright()
   {   
       String p = "";
       if (this.total_record > this.limit)
       {
           p = "<ul class='pagination pagination-sm no-margin pull-right '>";
   ...
   public String html_sm_activity()
   {   
       String p = "";
       if (this.total_record > this.limit)
       {
           p = "<ul class='pagination pagination-sm inline '>";
            
           // Nút prev và first
           if (this.current_page > 1)
           {
           	 p= p.concat( "<li><a data-option='"+this.get_link(1)+"' onclick='jsgetlog(this)' >First</a></li>");
           	 p= p.concat("<li><a data-option='"+this.get_link(this.current_page-1)+"'  onclick='jsgetlog(this)'  aria-label='Previous'>"
               		+ "<span aria-hidden='true'>&laquo;</span></a></li>");
           }
           ...
           for (int i = this.min; i <= this.max; i++)
           {
               ...
               if (this.current_page == i){
               	 ...
               	 p= p.concat ("<li><a data-option='"+this.get_link(i)+"'  onclick='jsgetlog(this)' >"+i+"</a></li>");
               }
           }
           ...
           if (this.current_page < this.total_page)
           {
           	 p= p.concat ("<li><a data-option='"+this.get_link(this.current_page + 1)+"'  onclick='jsgetlog(this)'   aria-label='Next'> "
           	 		+ "<span aria-hidden='true'>&raquo;</span></a></li>");
           	 p= p.concat ("<li><a data-option='"+this.get_link(this.total_page)+"  onclick='jsgetlog(this)' '>Last</a></li>");
           }
